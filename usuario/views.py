...
class UsuarioRegisterActivateView(RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        messages.success(self.request,
                         'Obrigado por acessar o Sistema de Avaliação Online de Artigos - SAOA. Esta é a sua área restrita de acompanhamento de Submissões e Avaliações de trabalhos.')
