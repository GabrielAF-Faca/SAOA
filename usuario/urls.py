...
from .views import UsuarioRegisterSuccessView, UsuarioRegisterSuccessFalhaEmailView, UsuarioRegisterActivateView, \
    UsuarioRegisterView
...
urlpatterns = [
    ...
    path('register/success_falha_email/', UsuarioRegisterSuccessFalhaEmailView.as_view(),
         name='usuario_register_success_falha_email'),
